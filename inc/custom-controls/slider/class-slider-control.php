<?php
/**
 * Digital Download Customizer Slider Control.
 * 
...
if ( ! class_exists( 'Digital_Download_Slider_Control' ) ){
	/**
	 * Slider control (range).
    */
	class Digital_Download_Slider_Control extends WP_Customize_Control {
        ...
        public function enqueue() {            
            wp_enqueue_style( 'digital-download-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.css', null );
            wp_enqueue_script( 'digital-download-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.js', array( 'jquery' ), false, true ); //for slider                
        }
