<?php
/**
 * Digital Download Repeater Customizer Setting.
 * 
...
if ( ! class_exists( 'Digital_Download_Repeater_Setting' ) ) {

	/**
	 * Repeater Settings.
	 */
	class Digital_Download_Repeater_Setting extends WP_Customize_Setting {
